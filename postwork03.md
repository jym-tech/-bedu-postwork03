...
- Inyecta en el proyecto de clase esta nueva sección Logros

- Utiliza flexbox para acomodar los elementos en pantalla

- Utiliza los elementos de position: absolute y position: relative

- Utiliza las herramientas de la consola de desarrollo de Chrome para experimentar con las opciones de Flexbox
...
## Juega varios niveles de Flexbox Froggy

Fueron completados todos los niveles.
